...
HD_PWD='R:/Desktop/SED2/VGA/VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_VGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_VGA.tcl -notrace
